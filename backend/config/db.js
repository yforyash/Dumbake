...
const mockState = {
  ...
  bakery_items: [
    { id: 1, name: 'Classic Butter Croissant', description: 'Flaky, buttery, golden-brown crescent-shaped French pastry baked fresh daily.', price: 120.00, category: 'Pastries', image_url: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=500&q=80', is_eggless: false, is_bestseller: true, stock_quantity: 25, status: 'available' },
    { id: 2, name: 'Belgian Chocolate Truffle Cake', description: 'Rich chocolate sponge layered with smooth dark Belgian chocolate ganache.', price: 650.00, category: 'Cakes', image_url: 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=500&q=80', is_eggless: true, is_bestseller: true, stock_quantity: 8, status: 'available' },
    { id: 3, name: 'French Macaron Box (6 pcs)', description: 'Assorted box of raspberry, chocolate, pistachio, lemon, salted caramel, and vanilla macarons.', price: 350.00, category: 'Pastries', image_url: 'https://images.unsplash.com/photo-1569864358642-9d1684040f43?w=500&q=80', is_eggless: false, is_bestseller: false, stock_quantity: 15, status: 'available' },
    { id: 4, name: 'Artisan Sourdough Loaf', description: 'Slow-fermented sourdough bread with a crispy crust and a chewy, airy interior.', price: 180.00, category: 'Breads', image_url: 'https://images.unsplash.com/photo-1549931319-a545dcf3bc73?w=500&q=80', is_eggless: true, is_bestseller: true, stock_quantity: 12, status: 'available' },
    { id: 5, name: 'Classic Red Velvet Pastry', description: 'Vibrant crimson sponge layer cake filled with vanilla bean cream cheese frosting.', price: 140.00, category: 'Pastries', image_url: 'https://images.unsplash.com/photo-1616541823729-00fe0aacd32c?w=500&q=80', is_eggless: true, is_bestseller: false, stock_quantity: 18, status: 'available' }
  ],
  orders: [],
  reviews: [
